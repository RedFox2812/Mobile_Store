...
const HomePage = () => {
  ...
  return (
    <div className=" h-full flex bg-[white]">
      ...
      <div className={`container--main ${showFilterExtra ? "reponsive" : ""}`}>
        <div className="container__header w-full flex items-center justify-between">
          <div className="search-box w-[40%] flex justify-between py-1 px-3 border border-main-clo">
            <input
              type="text"
                ...
                ? dataProducts.map((item) => {
                    const handleShowPrice = () => {
                      if (
                        ...
                        const lowPrice =
                          item.records.offers.lowPrice.toLocaleString("it-IT", {
                            style: "currency",
                            currency: "VND",
                          });
                        return (
                        ...
                        const price = item.records.offers.price.toLocaleString(
                          "it-IT",
                          {
                            style: "currency",
                            currency: "VND",
